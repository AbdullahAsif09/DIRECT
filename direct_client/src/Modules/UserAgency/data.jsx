...
export const userAgencyNavigationList = [
  {
    title: "Projects",
    type: "noChildren",
    navigate: "/useragency/projects",
    icon: <Science sx={{ color: "#F1F1F1" }} />,
  },
  {
    title: "Upload USR",
    navigate: "/useragency/uploadusr",
    type: "noChildren",
  ...
  },
  {
    ...
    checkRole: true,
    type: "noChildren",
    navigate: "/useragency/directrooms",
    icon: <Chat sx={{ color: "#F1F1F1" }} />,
  },
];

export const userAgencyMenuList = [
  { label: " User Agency", type: "link" },
