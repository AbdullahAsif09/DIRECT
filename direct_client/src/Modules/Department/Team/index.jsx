...
const columns = [
  ...
  { field: "email", flex: 1, headerName: "Email", width: 210 },
  { field: "phone", flex: 1, headerName: "Phone", width: 210 },
  { field: "role", flex: 1, headerName: "Role", width: 210 },
];
...
const ProjectManagers = () => {
  ...
  const isAdmin = role === roles.department[0];
  ...
  return (
    <Grid container marginTop={3}>
      ...
      <Modal open={open && isAdmin} onClose={handleClose}>
        <Box
          component="form"
