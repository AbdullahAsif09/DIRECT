import { Button, Checkbox, debounce, Grid, styled } from "@mui/material";
...
const VisuallyHiddenInput = styled("input")`
  ...
  width: 1px;
`;
function BreifIntro({ defaultFundingAgency, defaultUserAgency }) {
  ...
  console.log(values?.organization, "values?.organization");
